...
// SQL query
	...
	while($row = mysqli_fetch_array($rs)) {
	  ...
	  echo "<td><a href='updateuser.php?id=".$row['id']."'><img src='img/edit2.png'width='90' height='40'</a></td>";
          echo "<td><a href='deluser.php?id=".$row['id']."'><img src='img/delete3.png'width='90' height='40' ></td>";
