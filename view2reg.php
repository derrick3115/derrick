...
// SQL query
	...
	echo"<th bgcolor='grey'>Umurenge wa</th>";
        ...
        echo"<th bgcolor='grey'>Nimero y'ikibanza/isambu(UPI)1</th>";
        echo"<th bgcolor='grey'>Nimero y'ikibanza/isambu(UPI)2</th>";
        echo"<th bgcolor='grey'>Nimero y'ikibanza/isambu(UPI)3</th>";
	...
	while($row = mysqli_fetch_array($rs)) {
	  ...
	  echo "<td bgcolor='white'>" .$row['umurenge'] ."</td>" ;
          ...
          echo "<td bgcolor='white'>" .$row['upi1'] ."</td>" ;
          echo "<td bgcolor='white'>" .$row['upi2'] ."</td>" ;
          echo "<td bgcolor='white'>" .$row['upi3'] ."</td>" ;
