<html>
	...
	<link rel="icon" type="image/png" href="img/lms2.png">
        ...
        ?>       
        <center><h1>Abaturage</h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="feedcomment.php"><img src="img/search.jpg"></a>
...
// SQL query
	...
	echo"<th bgcolor='grey'>Amazina</th>";
	
	echo"<th bgcolor='grey'>Telefoni</th>";
	echo"<th bgcolor='grey'>IBITEKEREZO</th>";
