...
<html>
    ...
    <link href="css/1search.css" rel="stylesheet" type="text/css"/>
        ...
        <body background="img/9.jpg">
            <center>  
                <form class="form" action="search1reg.php" method="POST">
...
<th bgcolor='grey'>Akarere ka</th>
        ...
        <th bgcolor='grey'>Ibisobanuro</th>
                ...
                while ($line = mysqli_fetch_object($answer)) {
                    ...
                    echo"<tr><td>$id</td><td>$me1</td><td>$id1</td><td>$akarere</td><td>$umurenge</td><td>$akagari</td><td>$umudugudu</td><td>$telefoni</td><td>$upi</td><td>$intara</td><td>$ibisobanuro</td>";
                }
