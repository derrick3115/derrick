...
// SQL query
	...
	while($row = mysqli_fetch_array($rs)) {
	  ...
	  echo "<td >" .$row['umurenge'] ."</td>" ;
          ...
          echo "<td><a href='update1reg.php?id=".$row['id']."'><img src='img/edit1.png'width='30' height='40'</a></td>";
          echo "<td width=30><a href='delete1reg.php?id=".$row['id']."'><img src='img/delete.png'width='25' height='40' ></td>";
...
echo"</tr>";
 ...
 echo '</div>';
  ...
  <li> <a href="javascript:PrintDiv('pdfexport')">Export to pdf</a> </li><br>
  <a href="excel/export.php">Download here<img src="img/back.gif"></a>
